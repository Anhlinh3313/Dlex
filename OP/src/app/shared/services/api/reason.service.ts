...
export class ReasonService extends GeneralService {
  constructor(
    ...
    super(messageService, httpClient, environment.opapiUrl, 'Reason');
  }

  async getListReason(viewModel: any): Promise<ResponseModel> {
    const param = new HttpParams();
    const res = await this.postCustomApi('GetListReason', viewModel);
