...
@Component({
  selector: 'app-create-update-po-hub',
  templateUrl: './create-update-po-hub.component.html',
  styleUrls: ['./create-update-po-hub.component.scss']
})
export class CreateUpdatePoHubComponent extends BaseComponent implements OnInit {
  edit: boolean = false;
  ...
  async create() {
    ...
    if (res.isSuccess) {
      this.msgService.success("Tạo mới chi nhánh thành công");
      this.onClickCancel(true);
    } else {
