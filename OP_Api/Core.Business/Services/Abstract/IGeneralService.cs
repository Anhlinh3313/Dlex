...
namespace Core.Business.Services.Abstract
{
	public interface IGeneralService<TCreateViewModel, TUpdateViewModel, TInfoViewModel, TModel>
	{
        ...
        Task<ResponseViewModel> CreateMDF(TCreateViewModel viewModel);
        Task<ResponseViewModel> CreateMDF(List<TCreateViewModel> viewModel);
        ...
        ResponseViewModel FindBy(Expression<Func<TModel, bool>> predicate, bool isSortDescending, int? pageSize = null, int? pageNumber = null, string cols = null);
        ResponseViewModel FindBy(Expression<Func<TModel, bool>> predicate, bool isSortDescending, int? pageSize = null, int? pageNumber = null, params string[] includeProperties);
        ResponseViewModel Get(int id, string cols = null);
