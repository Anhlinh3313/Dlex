...
{
    public class CompensationInfoViewModel : EntitySimple
    {
        public CompensationInfoViewModel() { }
        //
        ...
        //
        public UserInfoViewModel HandleEmp { get; set; }
        public Hub CompensatoinHub { get; set; }
        public UserInfoViewModel CompensationEmp { get; set; }
