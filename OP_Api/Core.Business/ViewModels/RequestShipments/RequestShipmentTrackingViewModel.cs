...
{
    public class RequestShipmentTrackingViewModel : IEntityBase
    {
        public RequestShipmentTrackingViewModel()
        {
        }
        ...
        public virtual IEnumerable<Proc_RequestLadingSchedule_Joined> LadingSchedules { get; set; } = new Collection<Proc_RequestLadingSchedule_Joined>();
    }
}
