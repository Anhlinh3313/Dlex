...
SET ANSI_NULLS ON
GO
ALTER PROC [dbo].[Proc_GetUsersBySearchCode]
(
	@CompanyId INT = NULL,
	@PageNumber INT = null,
	@PageSize INT = NULL,
...
WITH _CTE AS(
				SELECT u.Id, u.TypeUserId, u.CompanyId, ur.RoleId, u.HubId, u.UserName, u.Code, u.Email, u.PhoneNumber, u.Address, u.FullName,
				...
				LEFT JOIN dbo.Core_UserRole AS ur ON ur.UserId = u.Id AND ur.IsEnabled = 1
				WHERE u.IsEnabled = 1
				AND u.CompanyId = @CompanyId
				AND (@SearchText IS NULL OR u.Code =@SearchText)
			)
