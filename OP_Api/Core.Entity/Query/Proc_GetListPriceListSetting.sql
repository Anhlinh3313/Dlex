...
BEGIN
	...
	SET NOCOUNT ON;
		WITH _CTE AS (
				 SELECT ps.Id, ps.Code, ps.Name, p.Code AS PriceListCode, c.Code AS CustomerCode, c.Name AS CustomerName, c.Id AS CustomerId, s.Id AS ServiceId, p.id AS PriceListId,
