...
{
    public class Proc_ReportDebtCODDetailByCustomerDetail : IEntityProcView
    {
        public const string ProcName = "Proc_ReportDebtCODDetailByCustomerDetail";
        ...
        public Proc_ReportDebtCODDetailByCustomerDetail()
        {
