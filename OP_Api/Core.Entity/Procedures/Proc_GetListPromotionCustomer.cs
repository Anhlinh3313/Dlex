...
{
    public class Proc_GetListPromotionCustomer : IEntityProcView
    {
        public const string ProcName = "Proc_GetListPromotionCustomer";
        [Key]
        ...
        public Proc_GetListPromotionCustomer() { }
        public static IEntityProc GetEntityProc(int? pageNumber = null, int? pageSize = null, string searchText = null, int? promotionId = null, int? customerId = null, int? companyId = null)
        {
            ...
            if (!promotionId.HasValue) PromotionId.Value = DBNull.Value;
            ...
            return new EntityProc(
                $"{ProcName} @PageNumber, @PageSize, @SearchText, @PromotionId, @CustomerId,  @CompanyId",
                new SqlParameter[] {
                    PageNumber,
                    PageSize,
                    SearchText,
