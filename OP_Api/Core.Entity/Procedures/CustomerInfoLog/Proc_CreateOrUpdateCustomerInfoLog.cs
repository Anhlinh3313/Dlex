...
{
    public class Proc_CreateOrUpdateCustomerInfoLog : IEntityProcView
    {
        public const string ProcName = "Proc_CreateOrUpdateCustomerInfoLog";
        [Key]
        public bool IsSuccess { get; set; }
        public string Message { get; set; }

        public Proc_CreateOrUpdateCustomerInfoLog() { }
            ...
            int? companyId = null)
        {
            ...
            return new EntityProc(
                $"{ProcName} @Code, @Name, @PhoneNumber, @CompanyName, @Address, @AddressNote, @ProvinceId, @DistrictId, @WardId, @Lat, @Lng, @SenderId, @CompanyId",
                new SqlParameter[] {
                    Code, Name, PhoneNumber, CompanyName, Address, AddressNote, ProvinceId, DistrictId, WardId, Lat, Lng, SenderId, CompanyId
                }
            );
        }
    }
