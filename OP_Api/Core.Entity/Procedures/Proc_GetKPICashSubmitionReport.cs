...
{
	public class Proc_GetKPICashSubmitionReport : IEntityProcView
	{
		public const string ProcName = "Proc_GetKPICashSubmitionReport";
		[Key]
		...
		public string CashSubmitionDate { get; set; }
		public string CashSubmitionTime { get; set; }
		public string RealCashSubmitionDate { get; set; }
		public string RealCashSubmitionTime { get; set; }
		public string EmpCreatedReportCode { get; set; }
		public string EmpCreatedReportName { get; set; }
		public string KPICashSubmitionResult { get; set; }
		public int? TotalCount { get; set; }


		public Proc_GetKPICashSubmitionReport() { }
