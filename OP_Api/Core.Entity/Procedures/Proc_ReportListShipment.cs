...
{
    public class Proc_ReportListShipment : IEntityProcView
    {
        public const string ProcName = "Proc_ReportListShipment";
        ...
        public DateTime? ModifiedWhen2 { get; set; }
        public string ReceiptCODStatusName { get; set; }
        public DateTime? ReceiptCODFirstLockDate { get; set; }

        public Proc_ReportListShipment()
        {
        }
            ...
            )
        {
            ...
            return new EntityProc(
                ...
                $"@IsCreateListReceiptCOD, @ListReceiptCODStatusId",
                new SqlParameter[] {
