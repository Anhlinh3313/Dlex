...
{
    public class Proc_GetListShipmentPushIncoming : IEntityProcView
    {
        public const string ProcName = "Proc_GetListShipmentPushIncoming";
        [Key]
        ...
        public Proc_GetListShipmentPushIncoming() { }
