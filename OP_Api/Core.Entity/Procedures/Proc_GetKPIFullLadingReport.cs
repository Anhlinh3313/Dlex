...
{
	public class Proc_GetKPIFullLadingReport : IEntityProcView
	{
		public const string ProcName = "Proc_GetKPIFullLadingReport";
		[Key]
		...
		public double? FullLadingLeadTime { get; set; }
		public string KPIStartingDate { get; set; }
		public int? DayOfWeekCOT { get; set; }
		public string KPIStartingTime { get; set; }
		...
		public Proc_GetKPIFullLadingReport() { }
