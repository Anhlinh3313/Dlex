...
{
    public class Proc_ReportEmployeeCollecting : IEntityProcView
    {
        public const string ProcName = "Proc_ReportEmployeeCollecting";
        ...
        public double TotalCollectingCOD { get; set; }
        public double TotalCollectingPrice { get; set; }
        public string PaymentTypeName { get; set; }
        public string PaymentCODTypeName { get; set; }
        public string ShipmentStatusName { get; set; }
        public int TotalCount { get; set; }
        public double TotalCollecting { get; set; }
        public bool? IsCreditTransfer { get; set; }
        public Proc_ReportEmployeeCollecting()
        {
