...
{
    public class Proc_ReportAllSchedule2 : IEntityProcView
    {
        public const string ProcName = "Proc_ReportAllSchedule2";
        ...
        public DateTime? DeadlineReceiptCOD { get; set; }
        ...
        public string DurationPaymentCOD { get; set; }
        public string KPIPayment { get; set; }
        public string KPIShipment { get; set; }
        public string DeliveryTimeInDeliveryArea { get; set; }
        ...
        public Proc_ReportAllSchedule2()
        {
        }
