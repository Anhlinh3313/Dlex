...
{
    public class Proc_GetRoles : IEntityProcView
    {
        public const string ProcName = "Proc_GetRoles";
        [Key]
        ...
        public string ParrentRoleName { get; set; }
        public int? CompanyId { get; set; }
        public string CompanyName { get; set; }
        public Int32? TotalCount { get; set; }

        public Proc_GetRoles() { }
        public static IEntityProc GetEntityProc(int? pageNumber = null, int? pageSize = null, string searchText = null, int? companyId = null)
        {
            ...
            return new EntityProc(
                ...
                new SqlParameter[] {
                    PageNumber, PageSize, SearchText, CompanyId
                }
            );
        }
    }
