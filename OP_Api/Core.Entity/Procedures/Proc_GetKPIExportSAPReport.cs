...
{
	public class Proc_GetKPIExportSAPReport : IEntityProcView
	{
		public const string ProcName = "Proc_GetKPIExportSAPReport";
		[Key]
		...
		public string RealExportDay { get; set; }
		public string RealExportTime { get; set; }
		public string EmpCreatedReportCode { get; set; }
		public string EmpCreatedReportName { get; set; }
		public string KPIExportResult { get; set; }
		public int? TotalCount { get; set; }


		public Proc_GetKPIExportSAPReport() { }
