...
{
	public class Proc_GetKPIConfirmCashSubmitionReport : IEntityProcView
	{
		public const string ProcName = "Proc_GetKPIConfirmCashSubmitionReport";
		[Key]
		...
		public string ConfirmCashSubmitionDate { get; set; }
		public string ConfirmCashSubmitionTime { get; set; }
		public string RealConfirmCashSubmitionDate { get; set; }
		public string RealConfirmCashSubmitionTime { get; set; }
		public string EmpComfirmCode { get; set; }
		public string EmpComfirmName { get; set; }
		public string KPIConfirmCashSubmitionResult { get; set; }
		public int? TotalCount { get; set; }


		public Proc_GetKPIConfirmCashSubmitionReport() { }
