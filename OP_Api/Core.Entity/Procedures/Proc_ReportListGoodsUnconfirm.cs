...
{
    public class Proc_ReportListGoodsUnconfirm : IEntityProcView
    {
        public const string ProcName = "Proc_ReportListGoodsUnconfirm";
        ...
        public Proc_ReportListGoodsUnconfirm()
        {
        }
            ...
            )
        {
            ...
            return new EntityProc(
                $"{ProcName} @DateFrom,@DateTo,@HubId,@PageNumber,@PageSize,@SearchText",
                new SqlParameter[] {
                    DateFrom,
                    DateTo,
                    HubId,
