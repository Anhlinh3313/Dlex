...
{
    public class Proc_CheckByShipmentNumberWarhouse : IEntityProcView
    {
        public const string ProcName = "Proc_CheckByShipmentNumberWarhouse";
        ...
        public Proc_CheckByShipmentNumberWarhouse()
        {
