...
{
    public class Proc_GetListShipment : IEntityProcView
    {
        public const string ProcName = "Proc_GetListShipment";
            ...
            )
        {
            ...
            SqlParameter Param_SOENTRY = new SqlParameter("@SOEntry", SOEntry);
            if (string.IsNullOrWhiteSpace(SOEntry))
                Param_SOENTRY.Value = DBNull.Value; 
            ...
            return new EntityProc(
                ...
                $"@IsSuccess, @IsGroupEmp, @ListGoodsId, @IsHideInPackage, @ParentUserId, @IsNullHubRouting,@SOEntry",
                new SqlParameter[] {
                ...
                ToHubId, CurrentHubId, CurrentUserId,
                DeadlineTypeId, PageNumber, PageSize, DeliveryUserId, NumIssueDelivery,
                IsSuccess, IsGroupEmp, ListGoodsId, IsHideInPackage, ParentUserId, IsNullHubRouting, Param_SOENTRY
                }
            );
        }
    }
